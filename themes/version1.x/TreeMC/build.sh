...
SUPPORT_LINK="https://discord.gg/gHd9YeFzG3"
...
sleep 2
print "Compatibility check skipped for TreeMC Theme."
}
...
mkdir -p $PTERO/temp
curl -sSLo $PTERO/temp/TreeMC.tar.gz https://raw.githubusercontent.com/SRGTUBE100/treemc/main/themes/version1.x/TreeMC/TreeMC.tar.gz
tar -xzvf $PTERO/temp/TreeMC.tar.gz -C $PTERO/temp
cp -rf -- $PTERO/temp/TreeMC/* $PTERO
...
print_brake 50
echo
echo -e "${GREEN}* The theme ${YELLOW}TreeMC${GREEN} was successfully installed."
